...
class Paciente:
    ...
    def set_id(self, id):
       if id<0:raise ValueError("seu ligma balls")
       self.__id = id

    def set_n(self, n):
       if n == "":raise ValueError("seu ligma balls")
       self.__n = n
...
class PacienteUI:
   ...
   @staticmethod
   def menu():
      print("1-Inserir, 2_Listar, 3-Atualizar, 4-Excluir, 5-Pesquisar, 6-Aniversariantes, 7-Fim")
